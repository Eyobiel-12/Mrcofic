      ...
      <section className="py-12 md:py-20 lg:py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
            ...
            <div className="w-16 md:w-24 h-0.5 md:h-1 bg-gold-600 mx-auto mb-4 md:mb-6"></div>
            <p className="text-body text-base md:text-lg max-w-2xl mx-auto px-4">
              Kom langs op ons kantoor voor een persoonlijk gesprek
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            {/* Contact Information */}
            <div className="luxury-card p-6 md:p-8 lg:p-10 animate-slide-up">
              <h3 className="text-2xl sm:text-3xl font-semibold text-primary-800 mb-4 md:mb-6 font-display">Contactgegevens</h3>
              <div className="w-12 md:w-16 h-0.5 bg-gold-600 mb-6 md:mb-8"></div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-1">Adres</p>
                    <p className="text-body text-base md:text-lg font-medium">Eikenlaan 11</p>
                    <p className="text-body text-sm md:text-base">3474 HB Zegveld</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-1">Telefoon</p>
                    <a href="tel:0624995871" className="text-primary-700 hover:text-primary-900 hover:underline font-medium text-base md:text-lg transition-colors">
                      06-24995871
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:marcofic2010@gmail.com" className="text-primary-700 hover:text-primary-900 hover:underline font-medium text-base md:text-lg transition-colors">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-1">Kantooruren</p>
                    <p className="text-body text-base md:text-lg font-medium">Maandag - Vrijdag: 09:00 - 17:00</p>
                    <p className="text-body text-base md:text-lg font-medium mt-1">Zaterdag: 11:00 - 15:00</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Google Maps */}
            <div className="luxury-card overflow-hidden p-0 animate-slide-up">
              <div className="w-full h-full min-h-[400px] md:min-h-[500px]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2449.9867386357505!2d4.828351076693126!3d52.116370071958194!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c677f898dfd0af%3A0x7e65b1dcacfad92e!2sMarcofic%20boekhouding!5e0!3m2!1sen!2snl!4v1764973118412!5m2!1sen!2snl"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
